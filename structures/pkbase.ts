...
const knownPkmImplementations: {
  [version: number]: {
    new (pkx: Uint8Array, box: number, slot: number, ghost: boolean): PkBase;
  };
} = {};
 ...
 */
export function registerPkmImpl(
  generation: number,
  impl: {
    new (pkx: Uint8Array, box: number, slot: number, ghost: boolean): PkBase;
  }
...
export default class PkBase {
  ...
  constructor(pkx: Uint8Array, box: number, slot: number, isGhost: boolean) {
    ...
    this.esv =
      ((((this.pid >> 16) & 65535) ^ (this.pid & 65535)) >> 4) & 0xffff;
  ...
  static deshuffle(pkx: Uint8Array, sv: number) {
    ...
    if (pkx.length > 232) util.copy(pkx, 232, ekx, 232, 28);
    return ekx;
  }
